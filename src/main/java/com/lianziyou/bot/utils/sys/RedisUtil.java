...
public final class RedisUtil {
     ...
     * @param value 值
     */
    public static <T> void setCacheMapValue(final String key, final Object hKey, final T value) {
    ...
    public static void deleteCacheMapValue(final String key) {
        HashOperations<String, String, ?> opsForHash = redisTemplate.opsForHash();
        opsForHash.delete(key);
    }

    public static void deleteMapValueByKey(final String mapKey, final Object... key) {
        HashOperations<String, String, ?> opsForHash = redisTemplate.opsForHash();
        opsForHash.delete(mapKey, key);
    }
    ...
    public static boolean setIfAbsent(String var1, int var2, long var3, TimeUnit var5) {
        return redisTemplate.opsForValue().setIfAbsent(var1, var2, var3, var5);
    }
