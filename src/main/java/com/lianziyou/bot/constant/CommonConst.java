...
public class CommonConst {
    ...
    public static final String REDIS_KEY_MP_TICKET_USER = "MP:TICKET:USER:";
     ...
     * 系统配置redis前缀
     */
    public static final String SYS_CONFIG = "SYS:CONFIG:COMMON";

    /**
     * 支付配置redis前缀
     */
    public static final String PAY_CONFIG = "SYS:CONFIG:PAY";

    /**
     * 支付配置redis前缀
     */
    public static final String GPT_CONFIG = "SYS:CONFIG:GPT";
     ...
     * mail 发送标题
     */
    public static final String EMAIL_TITLE = "SuperMind";

    /**
     * 百度token
     */
    public static final String BAIDU_TO_EXAMINE_REDIS_KEY = "SYS:CONFIG:BAIDU_TOKEN";

    /**
     * fstoken
     */
    public static final String FLAG_STUDIO_TOKEN = "SYS:CONFIG:FLAG_STUDIO";
     ...
     * gpt 3.5 token 最大限制
     */
    public static final Integer GPT_3_5_TURBO_16K_TOKENS = 4096 * 4;

    /**
     * gpt 3.5 token 最大限制
     */
    public static final Integer GPT_4_MAX_TOKENS = 4096 * 5;
     ...
     * 任务超时时间(分钟)
     */
    public static final Integer TIMEOUT_MINUTES = 10;
    ...
    public static final CopyOptions DEFAULT_COPY_OPTIONS = CopyOptions.create().setIgnoreNullValue(true).setIgnoreError(true);
