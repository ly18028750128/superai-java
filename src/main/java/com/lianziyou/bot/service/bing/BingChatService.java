package com.lianziyou.bot.service.bing;
...
public class BingChatService {
    ...
    private static Headers generateHeaders(SysConfig sysConfig) {
        ...
        return new Headers.Builder()
            ...
            .add("x-ms-useragent", "azsdk-js-controller-client-factory/1.0.0-beta.1 core-rest-pipeline/1.10.0 OS/Win32")
    ...
    private static class ChatHub {
        ...
        public void ask(BingChatReq req, Consumer<String> completionHandler, AsyncService asyncService) {
            ...
            try {
                ...
                headersInitConver.put("sec-ch-ua-full-version-list",
                ...
                headersInitConver.put("user-agent",
