...
import com.lianziyou.bot.utils.gpt.TokensUtil;
...
public class ChatCompletion implements Serializable {
    ...
    @NonNull
    @Builder.Default
    private String model = GPT_3_5_TURBO_16K.getName();
    ...
    public boolean checkTokens() {
        ...
        if (this.model.equals(GPT_3_5_TURBO_16K.name)) {
            return tokens > CommonConst.GPT_3_5_TURBO_16K_TOKENS;
        } else if (this.model.startsWith("gpt-3.5-turbo")) {
            return tokens > CommonConst.GPT_3_5_TURBO_0301_TOKENS;
        }

        return tokens > CommonConst.GPT_4_MAX_TOKENS;
    }
